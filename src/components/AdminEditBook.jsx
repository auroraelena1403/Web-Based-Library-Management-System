...
const AdminEditBook = ({
  ...
  if (multiple) {
    ...
    setData((preve) => ({
      ...preve,
      [name]: selectedValues, // Stocăm un array de categorii
    }));
  } else {
    setData((preve) => ({
      ...preve,
  ...
  return (
    <div className=''>
      ...
      <div className='fixed w-full  h-full bg-slate-700 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
